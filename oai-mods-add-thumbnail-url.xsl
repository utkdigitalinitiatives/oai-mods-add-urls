...
<xsl:stylesheet 
    ...
    <xsl:template match="mods:location[not(parent::mods:relatedItem)]">
        <xsl:copy>
            ...
            <xsl:element name="url">
                ...
                <xsl:value-of select="following::mods:identifier[starts-with(.,'https://')]"/>
            </xsl:element>
            <xsl:element name="url">
                <xsl:attribute name="access">
                    <xsl:value-of select="'preview'"/>
                </xsl:attribute>
                <xsl:value-of select="concat(following::mods:identifier[starts-with(.,'https://')],'/datastream/TN/view')"/>
            </xsl:element>
        </xsl:copy>
    </xsl:template>
    ...
    -->
    <xsl:template match="/mods:mods/mods:identifier[starts-with(.,'https://')]">
        <xsl:choose>
